...
class state_estimator_lcmt
{
    public:
         ...
         * LCM Type: float[2]
         */
        float      contactEstimate[2];

        /**
         * LCM Type: float[2]
         */
        float      contactEstimatebyLeg[2];
         ...
         * LCM Type: float[2]
         */
        float      support_center[2];

        /**
         * LCM Type: float[24]
         */
        float      polygon_vertex[24];
...
int state_estimator_lcmt::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    ...
    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->contactEstimate[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->contactEstimatebyLeg[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int64_t_encode_array(buf, offset + pos, maxlen - pos, &this->vertex_num, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->support_center[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_encode_array(buf, offset + pos, maxlen - pos, &this->polygon_vertex[0], 24);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __int32_t_encode_array(buf, offset + pos, maxlen - pos, &this->isLiftedUp, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int state_estimator_lcmt::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    ...
    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->contactEstimate[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->contactEstimatebyLeg[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __int64_t_decode_array(buf, offset + pos, maxlen - pos, &this->vertex_num, 1);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->support_center[0], 2);
    if(tlen < 0) return tlen; else pos += tlen;

    tlen = __float_decode_array(buf, offset + pos, maxlen - pos, &this->polygon_vertex[0], 24);
    if(tlen < 0) return tlen; else pos += tlen;
    ...
    tlen = __int32_t_decode_array(buf, offset + pos, maxlen - pos, &this->isLiftedUp, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
{
    uint64_t hash = 0x85d128d2ae09c611LL;
