...
public final class t12_command_struct implements lcm.lcm.LCMEncodable
{
    public short SWA;
    ...
    {
        if (classes.contains(lcmtypes.t12_command_struct.class))
            return 0L;
 
        classes.add(lcmtypes.t12_command_struct.class);
    ...
    public t12_command_struct(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public t12_command_struct(DataInput ins) throws IOException
    {
    ...
    public static lcmtypes.t12_command_struct _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        lcmtypes.t12_command_struct o = new lcmtypes.t12_command_struct();
    ...
    public lcmtypes.t12_command_struct copy()
    {
        lcmtypes.t12_command_struct outobj = new lcmtypes.t12_command_struct();
        outobj.SWA = this.SWA;
