...
import time
import os, sys
sys.path.append(os.environ['DREAMBOT_WS_ROOT'] + '/src')

from biped_lcm_types.python.lcm_response_lcmt import lcm_response_lcmt
from biped_lcm_types.python.lcm_command_struct import lcm_command_struct
