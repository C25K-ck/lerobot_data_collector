...
def main():
    ...
    while(True):
        ...
        if res:
            ...
            baoxiangzi_fang = [
                0.17, 0.25, 1.39, -1.56, -1.33, 0.16, 0.03, 
                0.25, -0.07, -1.59, 1.66, 1.41, -0.02, 0.07, 
                2.6, 2.6, 2.6, 2.6, 0.92, 2.8, 
                2.6, 2.6, 2.6, 2.6, 0.91, 2.79, 
                -0.0, 0.0, -0.0, -0.0]
            ...
            baoxiangzi_songshou = [
                ...
                3.07, 3.08, 3.08, 3.08, 0.92, 2.83, 
                0.01, -0.01, 0.0, 0.0]
            # act_p2p(p2p_motion, p2p_motion.q, bao_tai)
            act_p2p(p2p_motion, bao_tai, baoxiangzi_fang)
            act_p2p(p2p_motion, baoxiangzi_fang, baoxiangzi_songshou)
