...
'''
# DAOWEI_POS = [
#     -0.5, 0.04, 1.26, -1.0, -1.27, 0.44, 0.1, 
#     -0.5, -0.07, -1.35, 1.0, 1.42, -0.34, 0.08, 
#     1, 1, 2.31, 2.5, 0.91, 1.57, 
#     1, 2.3, 2.51, 2.5, 0.93, 1.57, 
#     0.01, 0.0, -0.0, 0.0]
...
PUTDOWN = [
    -0.3, 0.04, 1.26, -1.4, -1.27, 0.44, 0.1, 
    -0.3, -0.06, -1.35, 1.4, 1.42, -0.34, 0.08, 
    0.52, 1, 2.31, 2.5, 0.91, 1.57, 
    0.5, 2.3, 2.51, 2.5, 0.93, 1.57, 
    0.01, 0.0, -0.0, 0.0]
...
def main():
    ...
    while(True):
        ...
        if res:
            ...
            putdown =  [
                -0.44, 0.03, 1.27, -1.05, -1.32, 0.41, 0.09, 
                -0.48, 0.05, -1.35, 1.05, 1.42, -0.41, 0.16, 
                0.53, 0.99, 2.31, 2.49, 0.91, 1.57, 
                0.5, 2.31, 2.52, 2.51, 0.93, 1.57, 
                0.01, 0.0, -0.0, -0.0]
            
            # putdown =  [
            #     -0.44, 0.03, 1.27, -1.05, -1.32, 0.21, 0.09, 
            #     -0.48, 0.05, -1.35, 1.05, 1.42, -0.21, 0.16, 
            #     0.53, 0.99, 2.31, 2.49, 0.91, 1.57, 
            #     0.5, 2.31, 2.52, 2.51, 0.93, 1.57, 
            #     0.01, 0.0, -0.0, -0.0]
            ...
            songshouzhi = [
                ...
                1.5, 2.31, 3, 3, 0.93, 3, 
                0.01, 0.0, -0.0, -0.0]
            act_p2p(p2p_motion, putdown, songshouzhi)
            
            open_arm = [
                -0.44, 0.1, 1.27, -1.05, -1.32, 0.41, 0.09, 
                -0.48, -0.1, -1.35, 1.05, 1.42, -0.41, 0.16, 
                1.5, 1.5, 3, 3, 0.91, 3, 
                1.5, 2.31, 3, 3, 0.93, 3, 
                0.01, 0.0, -0.0, -0.0]
            ...
            open_plus_arm = [
                -0.44, 0.15, 1.27, -1.05, -1.32, 0.41, 0.09, 
                -0.48, -0.15, -1.35, 1.05, 1.42, -0.41, 0.16, 
                3, 3, 3, 3, 0.91, 3, 
                3, 3, 3, 3, 0.93, 3, 
                0.01, 0.0, -0.0, -0.0]
            ...
            initi_pos_shou = [
                -0.2, 0.04, 1.26, -1.6, -1.27, 0.44, 0.1, 
                -0.2, -0.07, -1.35, 1.6, 1.42, -0.34, 0.08, 
                3, 3, 3, 3, 0.91, 3, 
                3, 3, 3, 3, 0.93, 3, 
                0.01, 0.0, -0.0, 0.0]
            ...
            initi_pos = [
                ...
                3, 3, 3, 3, 0.93, 3, 
                0.01, 0.0, -0.0, 0.0]
            act_p2p(p2p_motion, open_plus_arm, initi_pos)
            act_p2p(p2p_motion, initi_pos, initi_pos_shou)
            
            # jiancetai =  [
            #     -0.3, 0.04, 1.26, -1.32, -1.27, 0.44, 0.1, 
            #     -0.36, -0.01, -1.35, 1.25, 1.42, -0.34, 0.08, 
            #     0.52, 1.04, 2.31, 2.5, 0.91, 1.57,
            #     0.51, 2.3, 2.51, 2.5, 0.93, 1.57, 
            #     0.01, 0.0, 0.0, 0.0]
            # act_p2p(p2p_motion, DAOWEI_POS, jiancetai)
            # jiancetai_song_shou =  [
            #     -0.3, 0.04, 1.26, -1.32, -1.27, 0.44, 0.1, 
            #     -0.36, -0.01, -1.35, 1.25, 1.42, -0.34, 0.08, 
            #     3, 3, 3, 3, 0.91, 3,
            #     3, 3, 3, 3, 0.91, 3,
            #     0.01, 0.0, 0.0, 0.0]
            # act_p2p(p2p_motion, jiancetai, jiancetai_song_shou)
