...
def main():
    ...
    while(True):
        ...
        if res:
            ...
            res = p2p_motion.get_current_pos()
            act_p2p(p2p_motion, p2p_motion.q, initi_pos_shou)
            act_p2p(p2p_motion, initi_pos_shou, initi_pos)
            act_p2p(p2p_motion, initi_pos, open_plus_arm)
            act_p2p(p2p_motion, open_plus_arm, open_arm)
            act_p2p(p2p_motion, open_arm, songshouzhi)
            act_p2p(p2p_motion, songshouzhi, putdown)
