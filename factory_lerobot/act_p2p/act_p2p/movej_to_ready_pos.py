...
if __name__ == "__main__":
    ...
    robot.movej_plan_target_position_list = [
                                                ...
                                                [
                                                    ...
                                                    0.2, -0.12, -1.57, 0.2, 1.57, 0.0, -0.0, 
                                                    3.07, 3.08, 3.08, 3.08, 0.92, 2.83, 
                                                    0.5, 0.5, 0.5, 0.5, 0.72, 1, 
                                                    0.01, -0.01, 0.0, 0.0],

                                                [
                                                    -0.04, 0.12, -0.0, -0.20, 0.03, 0.0, -0.0, 
                                                    1.0, -0.12, -1.57, 1.7, 1.57, 0.0, 0.0, 
                                                    3.07, 3.08, 3.08, 3.08, 0.92, 2.82, 
                                                    0.5, 0.5, 0.5, 0.5, 0.72, 1, 
                                                    0.01, -0.01, 0.0, 0.0],

                                                [
                                                    -0.04, 0.12, -0.0, -0.20, 0.03, 0.0, -0.0, 
                                                    0.0, -0.12, -1.7, 1.2, 1.57, 0.0, -0.0, 
                                                ...
                                                # [-0.04, 0.12, -0.0, -0.20, 0.03, 0.0, -0.0, 
                                                # 0.0, -0.12, -1.57, 1.5, 1.57, 0.0, -0.0, 
                                                # 3.08, 3.07, 3.08, 3.07, 0.92, 2.81, 
                                                # 0.5, 0.5, 0.5, 0.5, 0.72, 1, 
                                                # 0.01, -0.01, 0.0, 0.0],
