    ...
    while(True):
        ...
        if res:
            ...
            zhunbeizhua_pos = [
                ...
                0.15, -0.12, -1.57, 1.18, 1.57, -0.0, -0.0, 
            ...
            zhunbei_jia =  [
                ...
                3.08, 3.08, 3.08, 3.08, 0.92, 2.77, 
                3.08, 3.07, 3.08, 3.06, 0.93, 
                2.78, 0.01, 0.0, 0.0, -0.0]
            
            
            jia = [
                0.1, 0.03, 1.26, -1.05, -1.27, 0.25, -0.07, 
                0.11, 0.08, -1.35, 1.14, 1.42, -0.3, 0.05, 
                3.07, 3.08, 3.08, 3.08, 0.92, 2.77, 
                3.08, 3.07, 3.08, 3.06, 0.93, 2.78, 
                0.01, 0.0, 0.0, -0.0]
            act_p2p(p2p_motion, jia, zhunbei_jia)
            act_p2p(p2p_motion, zhunbei_jia, zhunbeizhua_pos)
            act_p2p(p2p_motion, zhunbeizhua_pos, GO_HOME_READY)
