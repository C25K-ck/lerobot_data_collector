...
class arm_control_cmd_lcmt(object):
    __slots__ = ["isUsed", "joint_tarPos", "joint_tarTor", "duration"]

    __typenames__ = ["int32_t", "float", "float", "float"]

    __dimensions__ = [[14], [14], [14], [14]]

    def __init__(self):
        self.isUsed = [ 0 for dim0 in range(14) ]
        self.joint_tarPos = [ 0.0 for dim0 in range(14) ]
        self.joint_tarTor = [ 0.0 for dim0 in range(14) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>14f', *self.joint_tarTor[:14]))
    ...
    def _decode_one(buf):
        ...
        self.joint_tarTor = struct.unpack('>14f', buf.read(56))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x236ecb7ee5149625) & 0xffffffffffffffff
