...
class leg_control_data_lcmt(object):
    __slots__ = ["q", "qd", "pos", "vel", "tau_est", "force_est", "force_desired", "knee_pos", "ankle_pos", "ft_sensor"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[12], [12], [12], [12], [12], [12], [12], [12], [6], [12]]
    ...
    def __init__(self):
        ...
        self.ankle_pos = [ 0.0 for dim0 in range(6) ]
        self.ft_sensor = [ 0.0 for dim0 in range(12) ]
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>6f', *self.ankle_pos[:6]))
        buf.write(struct.pack('>12f', *self.ft_sensor[:12]))
    ...
    def _decode_one(buf):
        ...
        self.ankle_pos = struct.unpack('>6f', buf.read(24))
        self.ft_sensor = struct.unpack('>12f', buf.read(48))
        return self
    _decode_one = staticmethod(_decode_one)

    def _get_hash_recursive(parents):
        if leg_control_data_lcmt in parents: return 0
        tmphash = (0x7b476b56e99b8873) & 0xffffffffffffffff
