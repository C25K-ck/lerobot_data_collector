...
class microstrain_lcmt(object):
    __slots__ = ["quat", "rpy", "omega", "acc", "temp", "good_packets", "bad_packets"]

    __typenames__ = ["float", "float", "float", "float", "float", "int64_t", "int64_t"]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc8c9cdaafc4a86bb) & 0xffffffffffffffff
