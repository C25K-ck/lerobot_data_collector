...
class offlineControlRos(Node):
    def __init__(self):
        super().__init__('offlineControlRos')



        self.publisher_qpos = self.create_publisher(Float32MultiArray, '/act_qpos', 10)
        self.timer_period_pub_data = self.create_timer(0.03, self.period_get_data)
    ...
    def remote_img_init(self):
        ...
        self.sub_head_rgb = self.create_subscription(Image,'/rgbd3/color/image_raw',self.image_head_callback,10)
    ...
    def image_left_hand_callback(self, msg):
        ...
        self.image_list[1] = left_hand_rgb
